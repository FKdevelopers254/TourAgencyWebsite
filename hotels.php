...
<section class="ftco-section ftco-degree-bg">
    ...
    <input class="form-control" id="myInput" type="text" name="search" placeholder="Hotel Name or City" required>
  </div>
...
<?php include('hotelsearch.php'); ?>
  ...
  <?php $sql = "SELECT * from hotel";
        ...
        {       ?>
          		...
          		<div class="col-md-4 ftco-animate">
		    				<div class="destination">
		    					<a href="index?o=Hotel&pid=<?php echo htmlentities($result->id);?>" class="img img-2 d-flex justify-content-center align-items-center" style="background-image: url(photos/<?php echo htmlentities($result->photo);?>);">
		    					...
		    					<div class="text p-3">
		    						<div class="d-flex">
		    							<div class="one">
				    						<h3><a href="index?o=Hotel&p=<?php echo htmlentities($result->id);?>"><?php echo htmlentities($result->hname);?></a></h3>
				    						<p class="rate">
				    							<i class="icon-star"></i>
				    							<i class="icon-star"></i>
				    							<i class="icon-star"></i>
     ...
     {  ?><?php echo htmlentities($result->countryname);?>  <?php  }} ?></span> 
		    							<span class="ml-auto"><a href="index?o=Hotel&p=<?php echo $pdd;?>">Discover</a></span>
		    						</p>
		    					</div>
		    				</div>
		    			</div>
