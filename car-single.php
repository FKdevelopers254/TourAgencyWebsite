<div  style="background-image: url('images/bg_1.jpg'); width:100%; height:80px;"></div>
      <?php
     $p=intval($_GET['p']);
     $sql = "SELECT * from vehicles where id=:p";
                ...
                <div class="row">
                    <div class="col-md-12 ftco-animate">
                        <div class="single-slider owl-carousel">
                            <div class="item">
                                <div class="hotel-img" style="background-image: url(photos/<?php echo htmlentities($result->Vimage1);?>);"></div>
                            </div>
                            <div class="item">
                                <div class="hotel-img" style="background-image: url(photos/<?php echo htmlentities($result->Vimage2);?>);"></div>
                            </div>
                            <div class="item">
                                <div class="hotel-img" style="background-image: url(photos/<?php echo htmlentities($result->Vimage3);?>);"></div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-9 hotel-single mt-4 mb-5 ftco-animate">
                        <span>Our Best Cars in Great Condtion</span>
     ...
     $sql = "SELECT * from country where id=:p";
     $query = $dbh -> prepare($sql);
     $query -> bindParam(':p', $p, PDO::PARAM_STR);
     $query->execute();
     $results=$query->fetchAll(PDO::FETCH_OBJ);
     ...
     foreach($results as $result)
     {  ?>
            <?php echo htmlentities($result->countryname);?> <?php  }} ?></a></span>
                            <span class="star">
                                <i class="icon-star"></i>
                                <i class="icon-star"></i>
                                <i class="icon-star"></i>
     ...
     foreach($results as $result)
     {  ?>
           <?php echo htmlentities($result->VehiclesOverview);?> <?php  }} ?></p>
     ...
     {  ?>
                            ...
                            <div class="col-md-4">
                                    <div class="destination">
                                        ...
                                        <div class="text p-3">
                                            <div class="d-flex">
                                                <div class="one">
                                                    <h3><a><?php echo htmlentities($result->VehiclesTitle);?></a></h3>
                                                    <p class="rate">
                                                        <i class="icon-star"></i>
                                                        <i class="icon-star"></i>
                                                        <i class="icon-star"></i>
                                                ...
                                                <div class="two">
                                                    <span class="price per-price">$<?php echo htmlentities($result->PricePerDay);?></span>
                                                </div>
                                            </div>
                                            <p><?php echo substr(($result->VehiclesOverview),0,300);?></p>
                                            <hr>
                                            <p class="bottom-area d-flex">
                                              
                                                <span class="ml-auto"><a href="index?o=CarRent&p=<?php echo htmlentities($result->id);?>">Discover</a></span>
                                            </p>
                                        </div>
                                    </div>
                ...
                <div class="col-md-12 hotel-single ftco-animate mb-5 mt-4">
                        <h4 class="mb-4">Related Tour Packages</h4>
                        <div class="row">         
                     <?php
     $p=$result->cityid;
     $sql = "SELECT * from tourpackages where cityid=:p";
     $query = $dbh -> prepare($sql);
     $query -> bindParam(':p', $p, PDO::PARAM_STR);
     $query->execute();
     $results=$query->fetchAll(PDO::FETCH_OBJ);
     ...
     {  ?><?php echo htmlentities($result->countryname);?>  <?php  }} ?></span>
                                                <span class="ml-auto"><a href="index?o=TourPackages&p=<?php echo $pdd;?>">Discover</a></span>
                                            </p>
                                        </div>
                                    </div>
